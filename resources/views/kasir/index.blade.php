          ...
          <table class="table table-bordered table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{ $data->Shift }}</td>
                <td>
                  <a href="{{ route('kasir.edit', $data->ID_Kasir) }}" class="btn btn-warning btn-sm">Edit</a>
                  <form action="{{ route('kasir.destroy', $data->ID_Kasir) }}" method="POST" style="display:inline;">
                    @csrf
                    @method('DELETE')
